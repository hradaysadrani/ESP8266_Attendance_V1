 //IoT based Attendance System with Google Sheets and ESP8266
#include <SPI.h>
#include <MFRC522.h>
#include <Arduino.h>
...
const String sheet_url = "https://script.google.com/macros/s/<URL>/exec?name=";  //Enter Google Script URL

#define WIFI_SSID "WiFi_SSID"  //Enter WiFi Name
#define WIFI_PASSWORD "WiFi_Password"  //Enter WiFi Password
//-----------------------------------------
